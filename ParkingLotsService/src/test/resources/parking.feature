Feature: LAMetro 1
    ...
    Scenario: Parks are or not free 2
        Given a parking lot with a total of 349 parking spaces and 7 disabled parking spaces and with 32 free parking spaces and 3 disabled free parking spacess
    ...
    Scenario: Parks are or not free 3
        Given a parking lot with a total of 349 parking spaces and 7 disabled parking spaces and with 0 free parking spaces and 0 disabled free parking spacesss
